...
public class main_character : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown("left"))
        {
            ...
            transform.position = now_desk.transform.FindChild("down").transform.position;
        }
        ...
        {
            transform.position = now_desk.transform.FindChild("up").transform.position;
        }
        else if (Input.GetKeyDown("a"))
        {
            transform.position = now_desk.transform.FindChild("left").transform.position;
        }
        ...
        {
            transform.position = now_desk.transform.FindChild("right").transform.position;
        }
    }
}
